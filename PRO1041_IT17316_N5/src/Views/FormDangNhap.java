...
public class FormDangNhap extends javax.swing.JFrame {
    ...
    private void btnDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangNhapActionPerformed
        ...
        TaiKhoan taiKhoan=iTaiKhoanService.checkAccount(email,pass);  
        if(taiKhoan==null){
            JOptionPane.showMessageDialog(this, "Tài khoản hoặc mật khẩu chưa đúng");
            return;
        }
        else if(taiKhoan.getLoaiTk().equalsIgnoreCase("khachhang")){
            JOptionPane.showMessageDialog(this, "khachhang Đăng nhập thành công");
        }
        else if(taiKhoan.getLoaiTk().equalsIgnoreCase("nhanvien")){
            JOptionPane.showMessageDialog(this, "nhanvien Đăng nhập thành công");
        }
        else if(taiKhoan.getLoaiTk().equalsIgnoreCase("quanly")){
